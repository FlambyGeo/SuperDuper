...
<body>
    ...
    <div id="main" style="margin-left:10%">
        ...
        <div class="tab">
            ...
            <button class="tablinks" onclick="openTab(event, 'voyelles')" >Vowels</button>
            <button class="tablinks" onclick="openTab(event, 'consonnes')">Consonnants</button>
            <button class="tablinks" onclick="openTab(event, 'lettres')">Quizz with all the letters</button>
            <button class="tablinks" onclick="openTab(event, 'villes')">Quizz with city names</button>
        </div>
        ...
        <div id="intro" class="tabcontent">
            ...
            <div class="finalcontent">
                <h3>Introduction</h3>
                <p>This guide will teach you how to read greek approximatively. The goal is that you can read city names, it is by no mean a complete guide t oreading greek perfectly.
                <p>For the sake of simplicity, all accents are ignored and each letters has a single translation from greek to latin alphabet in this guide, even though things are a lot more complicated if you want to read greek perfectly. </p>
            </div>
        </div>
        <div id="voyelles" class="tabcontent">
            ...
            <div class="finalcontent">
                ...
                <tbody>
                    ...
                    <tr><td>υ</td><td>y/u (one or the other)</td></tr>
                </tbody>
                </table>
            </div>   
            ...
            <div class="finalcontent">
                ...
                <table class="alpha">
                <thead>
                    <tr><th>Greek</th><th>Latin</th><th>Correct answer</th></tr>
                </thead>
                <tbody id="train_vo">
                </tbody>
                </table>
