...
<body>
    ...
    <div id="main" style="margin-left:10%">
        ...
        <div id="tryhard" class="tabcontent">
            ...
            <p>Les plaques de Floride ont 2 oranges avec des feuilles en plein centre. Peut se confondre avec certaines plaques de l'état voisie de Géorgie.</p>
            ...
            <p>Les plaques avec un point jaune (souvent au centre) sont en Géorgie. Remarque : elles ressemblent aux plaques de l'état voisin de Floride.</p>
