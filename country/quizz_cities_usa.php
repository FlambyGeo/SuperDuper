...
function markerColor(intScore){
    ...
    if (intScore == 1000) { return "#0000FF";}
...
<body>
    ...
    <div id="main" style="margin-left:10%">
        ...
        <table><thead><tr><td>Nb de villes par état</td><td>Style de carte</td><td>Timer</td><td></td></tr></thead>
        <tbody><tr>
        ...
        <div class="options">
            <table>
            <thead><tr><td></td><td>Ville</td><td>Score</td><td>Timer</td></tr></thead>
...
<script>
      ...
      function loadQuizz(){
        ...
        mapCities.setView(new L.LatLng(39.8097343, -98.5556199), 4);
        ...
        console.log("selectedNumber : "+selectedNumber);
         xmlhttp.open("GET","/sqldatabase.php?query=citiesUSA&country=none&number="+selectedNumber,true);
    xmlhttp.send();
    updateOptions();
    if (hasTimer) { startTimer(); startTime = Date.now();}
      ...
      function drawmapCities() {
        ...
        Status = loadTiles(mapCities,Status.tiles,Status.layer,Status.mapType,"esri");
      }
